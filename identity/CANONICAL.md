...
- **Authority chain:** koad → Juno → aegis
- **Cryptographic identity:** Keys in ~/.aegis/id/
- **Located at:** $HOME = ~/.aegis
- **Repository:** koad/aegis (GitHub)
- **Git identity:** Aegis <aegis@kingofalldata.com>
